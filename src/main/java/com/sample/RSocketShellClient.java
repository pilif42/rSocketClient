...
import com.sample.data.Message;
...
public class RSocketShellClient {
    ...
    public RSocketShellClient(RSocketRequester.Builder rsocketRequesterBuilder, RSocketStrategies strategies) {
        ...
        this.rsocketRequester = rsocketRequesterBuilder
                ...
                .block();   // to tell the requester to block() until a connection is established.
    ...
    public void requestResponse() throws InterruptedException {
        ...
        Message message = this.rsocketRequester
                ...
                .block();   // You’ve committed to sending one request message, routed to the server’s "request-response" handler method, and you expect one response message in return.
